...
public abstract class SampleMecanumDriveBase extends MecanumDrive {
    ...
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(2, 0, 0.1); //1, 0, 0.1
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(1, 0, 0); //1, 0, 0
